/*
Дата. Каждая из двух дат (в пределах одного года) вводиться в виде двух чисел: число и номер месяца, т.е. заданы: d1, m1, d2, m2.
Программа должна определить, какая дата раньше, и не совпадают ли они.(принять, что в каждом месяце 30 дней)
*/
#include <iostream>
using namespace std;
