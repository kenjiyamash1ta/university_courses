/*
Упаковка. Расчитать количество полностью заполненных ящиков ящиков и количество в не полностью 
заполненном ящике(если такой будет). товар штучный, известна емкость ящика (в штуках товара) и
